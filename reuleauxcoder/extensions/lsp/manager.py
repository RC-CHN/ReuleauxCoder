...
from reuleauxcoder.extensions.lsp.documents import (
    DocumentReader, _DocumentStamp,
)
...
class LspManager:
    ...
    _read_file_content = staticmethod(DocumentReader._read_file_content)

    _load_document_for_sync = staticmethod(DocumentReader._load_document_for_sync)

    _document_stamp = staticmethod(DocumentReader._document_stamp)

    _close_document_handle = staticmethod(DocumentReader._close_document_handle)
