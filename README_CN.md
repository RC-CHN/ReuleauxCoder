...
下载 [reuleauxcoder-0.11.0.vsix](https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.11.0/reuleauxcoder-0.11.0.vsix)，在 VS Code 中运行 **Extensions: Install from VSIX** 安装；Remote 窗口需安装到对应的工作区主机。
