...
```bash
pipx install https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.10.3/reuleauxcoder-0.10.3-py3-none-any.whl
```

或者使用 [`uv`](https://docs.astral.sh/uv/)：

```bash
uv tool install https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.10.3/reuleauxcoder-0.10.3-py3-none-any.whl
```
