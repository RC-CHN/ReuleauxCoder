...
The v0.5.1 CLI uses a prompt_toolkit mini-TUI with a persistent execution panel,
...
```bash
pipx install https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.5.1/reuleauxcoder-0.5.1-py3-none-any.whl
```

Or use [`uv`](https://docs.astral.sh/uv/) (v0.5.1+):

```bash
uv tool install https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.5.1/reuleauxcoder-0.5.1-py3-none-any.whl
```
