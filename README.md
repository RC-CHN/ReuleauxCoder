...
The v0.4.3 CLI uses a prompt_toolkit mini-TUI with a persistent execution panel,
...
```bash
pipx install https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.4.3/reuleauxcoder-0.4.3-py3-none-any.whl
```

Or use [`uv`](https://docs.astral.sh/uv/) (v0.4.3+):

```bash
uv tool install https://github.com/RC-CHN/ReuleauxCoder/releases/download/v0.4.3/reuleauxcoder-0.4.3-py3-none-any.whl
```
